...
<head>
  ...
  <script type="text/javascript">
    function load_page(i) {
        switch (i){
            case 1:
                document.getElementById("main").innerHTML = '<object type="text/html" data="Sale-CreateOrder.php" width="87%" height="190%"></object>';
                break;
            case 2:
                document.getElementById("main").innerHTML = '<object type="text/html" data="Sale-DeleteOrder.php" width="87%" height="190%"></object>';
                break;
            case 3:
                document.getElementById("main").innerHTML = '<object type="text/html" data="Sale-UpdateOrder.php" width="87%" height="190%"></object>';
                break;
            case 4:
                document.getElementById("main").innerHTML = '<object type="text/html" data="Sale-ViewOrder.php" width="87%" height="190%"></object>';
                break;
        }
    }
...
<body>
  ...
  <div class="leftMenu">
      <button class="dropbtn" onclick="load_page(1)">Create Order</button>
      <button class="dropbtn" onclick="load_page(2)">Delete Order</button>
      <button class="dropbtn" onclick="load_page(3)">Update Order</button>
      <button class="dropbtn" onclick="load_page(4)">View Order</button>
  </div>
